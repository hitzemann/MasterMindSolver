...
/**
 * Integrations-Testklasse für einen {@link ISolver}. Erzeugt alle möglichen
 * Kombinationen und lässt eine {@link ISolver}-Instanz gegen eine
 * {@link IErgebnisBerechnung}-Instanz antreten. Die Verarbeitung erfolgt
...
public final class SolverPerformanceIT {
	 ...
	 *             Der Haupt-Thread wurde (beim Warten auf Beendigung der Tasks)
	 *             unterbrochen.
