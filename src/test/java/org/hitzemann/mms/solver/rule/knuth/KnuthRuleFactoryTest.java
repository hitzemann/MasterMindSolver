...
public final class KnuthRuleFactoryTest {
    ...
    public void tetCreateGuessFixedSimpleRule() {
        final IRule rule = underTest.createGuessFixedSimpleRule(1, new SpielKombination(new int[0]), mock(IRule.class));
    ...
    public void testCreateGuessFixedComplexRule() {
        final IRule rule = underTest.createGuessFixedComplexRule(1, new SpielKombination(new int[0]), new IRule[1][0]);
