...
public final class GuessFirstRuleTest {
     ...
     */
    private static final Logger LOGGER = Logger.getLogger(GuessFirstRuleTest.class.getName());
    ...
    /**
     * Testet den Fehlerfall, dass das Minimum erwarteter Kandidaten größer ist als das Maximum.
     */
    @Test
    ...
    /**
     * Testet den Fehlerfall, dass das Minimum erwarteter Kandidaten kleiner als 0 ist.
     */
    @Test
    ...
    public void testTooFewCandidates() {
        final GuessFirstRule underTest = new GuessFirstRule(11, 19, ruleFactoryMock);
    ...
    public void testTooManyCandidates() {
        final GuessFirstRule underTest = new GuessFirstRule(1, 3, ruleFactoryMock);
    ...
    public void testNoCandidate() {
        final GuessFirstRule underTest = new GuessFirstRule(0, 2, ruleFactoryMock);
        ...
        try {
            ...
            Logger.getAnonymousLogger().log(Level.FINEST, "expected exception", e);
        }
    ...
    public void testFirstGuessed() {
        final GuessFirstRule underTest = new GuessFirstRule(10, 20, ruleFactoryMock);
    ...
    public void testNextRule() {
        ...
        final GuessFirstRule underTest = new GuessFirstRule(2, 12, ruleFactoryMock);

        when(ruleFactoryMock.createGuessFirstRule(anyInt(), anyInt())).thenReturn(expectedRule);

        assertSame(expectedRule, underTest.getRuleForResponse(new ErgebnisKombination(0, 0)));
