...
public final class DefaultSpielKombinationFactoryTest {
	...
	public static final class Allgemein {
		...
		/**
		 * Test für die bei negativem Parameter zu werfende
	...
	public static final class VariablePins {
		 ...
		 * 
		 * @return Liste von Arrays, die jeweils als Konstruktor-Parameter
		 *         verwendet werden.
		 */
		@Parameters
		...
		public void testAnzahl() {
			final int erwartet = BigInteger.valueOf(SpielStein.values().length)
					.pow(pins).intValue();
