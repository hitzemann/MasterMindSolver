...
public final class SpielKombinationTest {
    ...
    /**
     * Erzeugt eine zufällige {@link SpielKombination} mit zufälliger Länge (maximal {@value #MAX_PINS}).
     * 
     * @param rng
    ...
    /**
     * Testet stichprobenartig, ob {@link SpielKombination#compareTo(SpielKombination)} konsistent zu
    ...
    /**
     * Testet ob die beiden SpielKombination Konstruktoren die gleiche Objekte erzeugen.
     */
    @Test
    public void testConstructorsDoTheSame() {
        // TODO: Schleife für mehrere Kombinationen...
        final SpielKombination a = new SpielKombination(SpielStein.ROT, SpielStein.ROT, SpielStein.GRUEN,
                SpielStein.GRUEN);
        final SpielKombination b = new SpielKombination(1, 1, 2, 2);

        assertEquals("Constructors do not generate same objects a = " + a + ", b= " + b, a, b);
    }
}
