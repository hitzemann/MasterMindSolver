...
public class ErgebnisKombinationTest {
	...
	public final void testCompareToAntisymmetric() {
		...
		for (int i = 0; i < SAMPLES; i++) {
			...
			final ErgebnisKombination a = new ErgebnisKombination(aSchwarz,
					aWeiss);
			final ErgebnisKombination b = new ErgebnisKombination(bSchwarz,
					bWeiss);
	...
	public final void testCompareToTransitive() {
		...
		for (int i = 0; i < SAMPLES; i++) {
			...
			final ErgebnisKombination b = new ErgebnisKombination(bSchwarz,
					bWeiss);
			final ErgebnisKombination c = new ErgebnisKombination(cSchwarz,
					cWeiss);
			assertFalse(
	 ...
	 * {@link ErgebnisKombination#compareTo(ErgebnisKombination)} konsistent zu
