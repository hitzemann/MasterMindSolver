...
/**
 * <p>
 * Eine Regel, die immer die Kombination rät, für die die meisten verschiedenen Antworten möglich sind.
 * <p>
 * <p>
 * Zunächst werden alle Kombinationen mit der maximalen Anzahl verschiedener Antworten bei gegebener Kandidatenmenge
 * ermittelt.
 * </p>
 * <p>
 * Anschließend wird geprüft, ob unter diesen Kombinationen Elemente der Kandidatenmenge sind. Ist das der Fall, werden
 * nur diese weiter berücksichtigt.
 * </p>
 * <p>
 * Von den verbleibenden Kombinationen wird die lexikographisch kleinste als zu ratende Kombination geliefert.
 * </p>
 * 
 * @author chschu
 */
public final class MostPartsRule implements IRule {
     ...
     */
    public MostPartsRule(final IErgebnisBerechnung theCalculator, final ISpielKombinationFactory factory, final int pins) {
