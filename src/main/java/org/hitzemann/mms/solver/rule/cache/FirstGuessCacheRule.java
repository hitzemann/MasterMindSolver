 ...
 * 
 * <p>
 * Damit sich der Cache für den Aufrufer neutral verhält, muss die von der gekapselten Regel bei {@link
 * IRule#getGuess(List<SpielKombination>)} zurückgegebene {@link SpielKombination} konstant sein.
 * </p>
 * 
 * @author chschu
 */
public final class FirstGuessCacheRule implements IRule {
     ...
     *            Die gekapselte Regel.
     * @param theGuess
     *            Der zu verwendende Zug, oder <code>null</code> falls er automatisch ermittelt werden soll.
     */
    public FirstGuessCacheRule(final IRule theDelegate, final SpielKombination theGuess) {
