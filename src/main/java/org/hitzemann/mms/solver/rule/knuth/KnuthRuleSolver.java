 ...
 * 
 * <p>
 * Die verwendete Regel wird rekursiv beschrieben. Wenn n die Anzahl der
 * Kandidaten ist, dann gibt es die folgenden Arten von Regeln:
 * </p>
 * 
 * <ol>
 * <li>n, n &lt;= 2</li>
 * <li>n(y<sub>1</sub>y<sub>2</sub>y<sub>3</sub>y<sub>4</sub>), n &gt; 2 und
 * nach dem Raten der Kombination
 * y<sub>1</sub>y<sub>2</sub>y<sub>3</sub>y<sub>4</sub> ist die geheime
 * Kombination eindeutig definiert</li>
 * <li>n(y<sub>1</sub>y<sub>2</sub>y<sub>3</sub>y<sub>4</sub>x), n &gt; 2 und
 * nach dem Raten der Kombination
 * y<sub>1</sub>y<sub>2</sub>y<sub>3</sub>y<sub>4</sub> ist die geheime
 * Kombination nicht eindeutig bestimmt, aber auf maximal 2 Möglichkeiten
 * beschränkt</li>
 * <li>n(y<sub>1</sub>y<sub>2</sub>y<sub>3</sub>y<sub>4</sub>:
 * a<sub>04</sub>,a<sub
 * >03</sub>,a<sub>02</sub>,a<sub>01</sub>,a<sub>00</sub>;a<sub
 * >13</sub>,a<sub>12
 * </sub>,a<sub>11</sub>,a<sub>10</sub>;a<sub>22</sub>,a<sub>21
 * </sub>,a<sub>20</sub>;a<sub>31</sub>,a<sub>30</sub>;a<sub>40</sub>), n &gt; 2
 * und nach dem Raten der Kombination
 * y<sub>1</sub>y<sub>2</sub>y<sub>3</sub>y<sub>4</sub> mit der Antwort &bdquo;j
 * schwarz, k weiss&ldquo; wird mit der Folge-Regel a<sub>jk</sub> fortgesetzt</li>
 * </ol>
 * 
 * <p>
 * Für n = 1 ist die geheime Kombination bekannt, muss aber ggf. noch geraten
 * werden.
 * </p>
 * 
 * <p>
 * Für n = 2 kann eine beliebige der beiden Möglichkeiten geraten werden, danach
...
public final class KnuthRuleSolver extends RuleSolver {
	 ...
	 */
	private static final String ALL = MAIN.replace("A", A).replace("B", B)
