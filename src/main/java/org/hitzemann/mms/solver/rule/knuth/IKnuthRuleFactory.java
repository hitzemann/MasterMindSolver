...
public interface IKnuthRuleFactory {
     ...
     */
    IRule createGuessFirstRule(int minimumCandidateCount, int maximumCandidateCount);
     ...
     * @return Die neu erzeugte Regel-Instanz.
     */
    IRule createGuessFixedSimpleRule(int expectedCandidateCount, SpielKombination guess, IRule nextRule);
     ...
     * @return Die neu erzeugte Regel-Instanz.
     */
    IRule createGuessFixedComplexRule(int expectedCandidateCount, SpielKombination guess, IRule[][] nextRules);
}
