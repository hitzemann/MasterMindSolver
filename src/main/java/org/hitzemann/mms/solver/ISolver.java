...
public interface ISolver {
	...
	/**
	 * Diese Methode sollte den letzten Zug auswerten, 
	 * nachdem eine ErgebnisKombination zurückgekommen ist.
	 * @param zug Der zuletzt getätigte Zug
	 * @param antwort Das Ergebnis für den zuletzt getätigten Zug
	 */
