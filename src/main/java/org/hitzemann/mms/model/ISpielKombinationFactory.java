...
public interface ISpielKombinationFactory {
     ...
     * 
     * @param pins
     *            Die Länge der {@link SpielKombination}en. Darf nicht negativ sein.
     * @return Eine gemäß {@link SpielKombination#compareTo(SpielKombination)} aufsteigend sortierte {@link List} mit
     *         allen {@link SpielKombination}en der angegebenen Länge.
